    ...
    public void processSipMetaData(JBossConvergedSipMetaData convergedMetaData, SipContextImpl convergedContext)
        ...
        if (sipServlets != null) {
            ...
            for (ServletMetaData value : sipServlets) {
                ...
                InstanceFactory<Servlet> factory = new InstanceFactory<Servlet>() {
                    @Override
                    public InstanceHandle<Servlet> createInstance() throws InstantiationException {
                        try {
                            Servlet instance = servletClass.getDeclaredConstructor().newInstance();
                ...
                ServletInfo servletInfo = new ServletInfo(value.getName(), servletClass, factory);
