...
public class SipContextImpl implements SipContext {
    ...
    List<UndertowListener> webServerListeners = new LinkedList<>();
    ...
    public boolean listenerStop() {
        ...
        if (servletContextListeners != null) {
            ...
            for (ServletContextListener servletContextListener : servletContextListeners) {
                ...
                try {
                    logger.warn("Fix needed (legacy code): fireContainerEvent(beforeContextDestroyed, servletContextListener)");
                } catch (Throwable t) {
    ...
    public List<UndertowListener> getWebServerListeners() {
        return webServerListeners;
    }

    public void setWebServerListeners(List<UndertowListener> webServerListeners) {
