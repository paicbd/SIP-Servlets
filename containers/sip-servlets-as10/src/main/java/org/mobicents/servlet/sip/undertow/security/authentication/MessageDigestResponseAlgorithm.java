 ...
 *         from sip-servlet-as7 project, re-implemented for jboss as10 (wildfly) by:
 * @author kakonyi.istvan@alerant.hu
 */

public class MessageDigestResponseAlgorithm {
    private static final Logger logger = Logger.getLogger(MessageDigestResponseAlgorithm.class.getName());
    ...
    static String calculateResponse(String algorithm, String hA1, String nonce_value, String nc_value, String cnonce_value,
