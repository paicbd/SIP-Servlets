...
public class ConvergedSessionListenerBridge extends SessionListenerBridge{
    ...
    public ConvergedSessionListenerBridge(Deployment deployment, ApplicationListeners applicationListeners, ServletContext servletContext) {
        super(deployment, applicationListeners, servletContext);
        this.threadSetup =  new ThreadSetupAction() {
            @Override
            public Handle setup(HttpServerExchange httpServerExchange) {
                return null;
            }
        };
        this.applicationListeners = applicationListeners;
        this.servletContext = servletContext;
        this.manager = deployment.getSessionManager();
    }
