...
public class SipDefinition extends SimpleResourceDefinition {
    ...
    public void registerAttributes(ManagementResourceRegistration registration) {
        ...
        registration.registerReadWriteAttribute(GATHER_STATISTICS, null, new ReloadRequiredWriteAttributeHandler(GATHER_STATISTICS));
        registration.registerReadWriteAttribute(CALL_ID_MAX_LENGTH, null, new ReloadRequiredWriteAttributeHandler(CALL_ID_MAX_LENGTH));
        registration.registerReadWriteAttribute(TAG_HASH_MAX_LENGTH, null, new ReloadRequiredWriteAttributeHandler(TAG_HASH_MAX_LENGTH));
